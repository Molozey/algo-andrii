...
def create_csv(file_name, numberST):
    ...
    params = {
        ...
        "MaxHold": [str(int(x))+'T' for x in np.linspace(60, 450, 12)],
        "WindowRoll": [str(int(x))+'T' for x in np.linspace(70, 950, 18)],
...
parser.add_argument('--approx', help='number of insample strategies', default=340)
