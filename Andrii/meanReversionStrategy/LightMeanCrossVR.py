...
def create_csv(file_name, numberST):
    ...
    params = {
        "BuyLossPercent": np.linspace(.2, 1.8, 4),
        #"SellLossPercent": [20, 30, 40],
        "BuyTakePercent": np.linspace(1, 4.8, 4),
        #"SellTakePercent": [20, 30, 40],
        "MaxHold": [str(int(x))+'T' for x in np.linspace(30, 450, 12)],
...
parser.add_argument('--approx', help='number of insample strategies', default=8040)
